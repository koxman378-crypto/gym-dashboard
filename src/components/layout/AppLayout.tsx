  ...
  return (
    <TooltipProvider>
      <SidebarProvider>
        ...
        >
          <SidebarHeader className="border-b border-slate-200 dark:border-slate-800">
            <div className="flex items-center gap-3 px-3 py-4">
              ...
              <h2 className="text-lg font-semibold text-slate-900 dark:text-slate-100 group-data-[collapsible=icon]:hidden">
                Gym Manager
              </h2>
            </div>
          </SidebarHeader>
                ...
                .map((item) => (
                  <SidebarMenuItem key={item.href}>
                    <SidebarMenuButton
                      ...
                      tooltip={item.title}
                      className="px-3 py-2.5 hover:bg-slate-100 dark:hover:bg-slate-900 data-[active=true]:bg-slate-900 data-[active=true]:text-white dark:data-[active=true]:bg-slate-100 dark:data-[active=true]:text-slate-900"
                    >
                      <Link
                        href={item.href}
          ...
          <SidebarFooter className="border-t border-slate-200 dark:border-slate-800 mt-auto">
            {user && (
              <div className="px-2 py-3">
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <button className="flex items-center gap-3 px-3 py-2 rounded-lg bg-slate-50 dark:bg-slate-900/50 mb-2 w-full hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors">
                      {user.avatar ? (
                        <img
                          src={user.avatar}
                          alt={user.name}
        ...
        <SidebarInset>
          <header className="sticky top-0 z-10 flex h-16 items-center gap-4 border-b border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-6">
