      ...
      <div className="flex items-center gap-4">
        <div className="relative">
          {logo ? (
            ...
            <div className="flex h-24 w-24 items-center justify-center rounded-full border border-gray-200 bg-gradient-to-br from-zinc-100 via-white to-zinc-200 shadow-inner">
