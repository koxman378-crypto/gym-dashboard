...
const translations = {
  ...
  expenses: {
    ...
    branch: { en: "Gym branch", mm: "ဂျင်မ်ခွဲ" },
    selectBranch: { en: "Select branch", mm: "ဂျင်မ်ခွဲ ရွေးချယ်ပါ" },
  },
  gymPrices: {
  ...
  notifications: {
    ...
    labelGymPackage: { en: "Gym package", mm: "ဂျင်မ်ပက်ကေ့ချ်" },
    typeTrainer: { en: "Trainer", mm: "သင်တန်းဆရာ" },
    typeService: { en: "Service", mm: "ဝန်ဆောင်မှု" },
    labelServices: { en: "Services", mm: "ဝန်ဆောင်မှုများ" },
